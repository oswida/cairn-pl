...
# PDF
pandoc -V geometry:margin=2.5cm --variable papersize=A4 --variable title="Cairn: Artefakty" --variable subtitle="Przygotowany " --variable subtitle="$date" --variable subtitle="\linebreak przez Oskara Świda| Oryginał dostępny na: cairnrpg.com \linebreak CC-BY-SA 4.0" -V fontfamily:Alegreya -H relics-cover.tex -f gfm --toc -s tmp/*.md -o "$SCRIPT_DIR/cairn-pl-relics.pdf"
...
COVER_IMG=$SCRIPT_DIR/covers/cover-relics-pf.jpg
